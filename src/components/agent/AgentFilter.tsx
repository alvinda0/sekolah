// components/AgentFilter.tsx
"use client";

import React, { useState, useEffect } from "react";
import { Search, Filter, X, ChevronDown } from "lucide-react";
import { AgentQueryParams } from "@/types/agent";
...
export const AgentFilter: React.FC<AgentFilterProps> = ({ onApplyFilters }) => {
  ...
  const applyFilters = () => {
    ...
    if (agentTypeId !== "all") filters.agent_type_id = Number(agentTypeId);
    if (status !== "all") filters.status = status;
    if (platformId !== "all") filters.platform_id = Number(platformId);
