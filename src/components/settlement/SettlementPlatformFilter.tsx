// components/settlement-platform/SettlementPlatformFilter.tsx
"use client";
...
interface SettlementPlatformFilterProps {
    onApplyFilters: (filters: SettlementPlatformQueryParams) => void;
}

export const SettlementPlatformFilter: React.FC<SettlementPlatformFilterProps> = ({
    onApplyFilters,
}) => {
    ...
    const applyFilters = () => {
        const filters: SettlementPlatformQueryParams = {
            page: 1,
            limit: 10,
        };
                ...
                <div className="flex-1 min-w-[300px]">
                    ...
                    <div className="relative mt-2">
                        ...
                        <Input
                            ...
                            placeholder="Search by platform name or reference..."
