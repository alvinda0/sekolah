...
const DisbursementPlatformDetailPage = () => {
  usePageTitle("Disbursement Platform Details");
  const params = useParams();
  const router = useRouter();
  const disbursementId = params.id as string;

  const [disbursement, setDisbursement] = useState<DisbursementPlatform | null>(
    null
  );
  ...
  const fetchDisbursementDetails = useCallback(async () => {
    try {
      setLoading(true);
      const data =
        await disbursementPlatformService.getDisbursementPlatformById(
          disbursementId
        );
      ...
      const errorMessage =
        err instanceof Error
          ? err.message
          : "Failed to fetch disbursement platform details";
      ...
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Loading disbursement platform details...
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-red-600 font-bold">
            {error || "Disbursement platform not found"}
          </p>
          <button
            onClick={() => router.back()}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">
            Disbursement Platform Details
          </h1>
          <p className="text-sm text-gray-600">
            View complete information about the disbursement platform
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/50 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
        {/* Header Section */}
        <div
          className={`bg-gradient-to-r ${getStatusBadgeColor(
            disbursement.status
          )} p-6`}
        >
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-3 py-1 rounded-lg bg-white/20 backdrop-blur-sm text-white text-xs font-bold border border-white/30">
      ...
      {/* Summary Card */}
      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 backdrop-blur-sm rounded-2xl border border-blue-200 p-6">
        <h3 className="text-lg font-bold text-gray-800 mb-4">
          Transaction Summary
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg p-4 border border-blue-300">
...
export default withRoleProtection(DisbursementPlatformDetailPage, [
  "PlatformOwner",
  "PlatformStaff",
]);
